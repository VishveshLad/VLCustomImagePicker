...
extension CustomImagePickerVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        if let cell = cell as? ImagePickerCell {
            ...
            cell.viewInfo.isHidden = objPHAsset.mediaType == .video ? false : true
...
class ImagePickerCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        self.viewInfo.translatesAutoresizingMaskIntoConstraints = false
        self.lblInfo.translatesAutoresizingMaskIntoConstraints = false
        self.contentView.addSubview(self.imageView)
        self.contentView.addSubview(self.selectedImageView)
        self.contentView.addSubview(self.viewInfo)
        self.viewInfo.addSubview(self.lblInfo)
        // Set Image View
        ...
        // Set Info Label
        self.lblInfo.rightAnchor.constraint(equalTo: self.viewInfo.rightAnchor, constant: -5.0).isActive = true
        self.lblInfo.bottomAnchor.constraint(equalTo: self.viewInfo.bottomAnchor, constant: -5.0).isActive = true
        self.lblInfo.leftAnchor.constraint(equalTo: self.viewInfo.leftAnchor, constant: 5.0).isActive = true
        self.lblInfo.topAnchor.constraint(equalTo: self.viewInfo.topAnchor, constant: 5.0).isActive = true
        self.lblInfo.translatesAutoresizingMaskIntoConstraints = false
        
        // Set view Info Label
        self.viewInfo.rightAnchor.constraint(equalTo: self.contentView.rightAnchor).isActive = true
        self.viewInfo.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor).isActive = true
        self.viewInfo.leftAnchor.constraint(equalTo: self.lblInfo.leftAnchor).isActive = true
        self.viewInfo.topAnchor.constraint(equalTo: self.lblInfo.topAnchor).isActive = true
        self.viewInfo.translatesAutoresizingMaskIntoConstraints = false
